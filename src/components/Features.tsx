...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Reduce reputational, legal, and compliance risks with early detection of unauthorized subletting."
    },
    {
      icon: FileText,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="p-6 rounded-lg bg-gray-800/50 backdrop-blur-sm border border-gray-700">
