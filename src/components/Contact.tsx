  ...
  return (
    <div className="w-full py-12 sm:py-16 md:py-24 bg-black px-4 sm:px-6" id="contact-section">
      <div className="container mx-auto flex flex-col items-center text-center">
        <div className="font-sans w-full max-w-xl flex flex-col items-center rounded-2xl mb-6 sm:mb-8 md:mb-10 bg-black border border-[hsl(24,97%,40%)] p-4 sm:p-6 md:p-8 shadow-lg animate-fade-in">
